...
RCPP_MODULE(BYM2MCMC_module) {

  class_<BYM2MCMC>("BYM2MCMC")
  .constructor<arma::mat, arma::vec, arma::mat, double, double>()

  .field("X", &BYM2MCMC::X)
  .field("y", &BYM2MCMC::y)
  .field("Q", &BYM2MCMC::Q)
  .field("beta", &BYM2MCMC::beta)
  .field("gamma", &BYM2MCMC::gamma)
  .field("rho", &BYM2MCMC::rho)
  .field("sigma2", &BYM2MCMC::sigma2)
  .field("delta_rho", &BYM2MCMC::delta_rho)

  .method("initOLS", &BYM2MCMC::initOLS)
  .method("MCMCSample", &BYM2MCMC::MCMCSample)
  .method("BurnMCMCSample", &BYM2MCMC::BurnMCMCSample)
  .method("updateBeta", &BYM2MCMC::updateBeta)
  .method("updateGamma", &BYM2MCMC::updateGamma)
  ;
}
