---
title: "Simulation Example: Simulated Count Outcome"
author: "Kyle Lin Wu"
...
We use the collected samples to compute difference probabilities of the form $\tau_{k}(\epsilon) = \Pr \left(\left.\frac{|c_k^{T}\phi|}{\sqrt{\mbox{Var}(c_k^{T} \phi \,|\, y)}} > \epsilon \;\right|\; y \right).$ 
...
We also compute unstandardized difference probabilities of the form $\tau_{ij} = \mathbb{P}(|\phi_{i} - \phi_j| > \epsilon \,|\, y)$ to compare the classification performance:
