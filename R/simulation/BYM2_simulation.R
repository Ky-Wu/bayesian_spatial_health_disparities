...
eps_optim <- optim(median(abs(phi_diffs)), function(e) {
  e_vij <- ComputeSimVij(t(phi_diffs), ij_list, epsilon = e)
...
e2_vij <- ComputeSimVij(t(phi_diffs), ij_list,
                        epsilon = e2)
e3_vij <- ComputeSimVij(t(phi_diffs), ij_list,
                        epsilon = e3)
e4_vij <- ComputeSimVij(t(phi_diffs), ij_list,
                        epsilon = e4)
e5_vij <- ComputeSimVij(t(phi_diffs), ij_list,
                        epsilon = e5)
